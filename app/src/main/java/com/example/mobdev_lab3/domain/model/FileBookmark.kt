package com.example.mobdev_lab3.domain.model
...
enum class BookmarkColor(val colorResId: Int, val displayName: String) {
    RED(R.color.holo_red_light, "Важное"),
    BLUE(R.color.holo_blue_light, "Работа"),
    GREEN(R.color.holo_green_light, "Проекты"),
    ORANGE(R.color.holo_orange_light, "Документы"),
    PURPLE(R.color.holo_purple, "Медиа")
}
